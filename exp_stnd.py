...
for name in names:
    ...
    for i, seed in enumerate(seeds):
        ...
        df = pd.concat([df, df_])
    df.to_excel(f"./exports/rslt_{name.lower()}_exp_stnd.xlsx")
