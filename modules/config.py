...
class HypergraphBatchLoader:
    """
    Custom dataloader for TMPHN graph classification.
    Produces batches as LISTS of Data objects.
    """

    def __init__(self, dataset: List[Data], batch_size: int, shuffle: bool = True):
